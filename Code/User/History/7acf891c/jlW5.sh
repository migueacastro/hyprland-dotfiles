...
echo "DIR: $DIR"  # Imprime el valor de DIR

if [ -r "$DIR/config.example" ]; then
    echo "Encontrado $DIR/config.example" # Imprime si encuentra el archivo
    source "$DIR/config.example"
else
    echo "No se encontro $DIR/config.example" # Imprime si NO encuentra el archivo
fi

echo "FIELDS: $FIELDS" # Imprime el valor de FIELDS (para verificar si se cargo la config)
echo "HOME/.config/rofi/wifi: ${HOME}/.config/rofi/wifi"
if [ -r "${HOME}/.config/rofi/wifi" ]; then
    echo "Encontrado ${HOME}/.config/rofi/wifi"
    source "${HOME}/.config/rofi/wifi"
else
    echo "No se encontro ${HOME}/.config/rofi/wifi"
fi
echo "FIELDS: $FIELDS"
