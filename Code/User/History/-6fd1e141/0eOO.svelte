            ...
            <div class="flex pb-[1rem]">
                ...
                <div class="lg:ml-[45%] w-1/3 text-center lg:text-start pt-[1rem] md:ml-[5%]">
                    <div class="lg:hidden mx-auto">
                        <a href="/dashboard" class="flex dark:hidden md:h-[3rem]  md:ml-[5%]">
                            <img src={logo} alt="">
                        </a>
                        <a href="/dashboard" class="hidden dark:flex  object-center">
                            <img src={logolight} alt="">
                        </a>
                    </div>
                </div>
                <div class="w-1/3 pt-[1rem] pr-[1rem] lg:pr-[2rem] flex flex-row justify-end">
                    <div class="lg:text-xl text-md capitalize text-end font-bold md:h-full md:text-xl md:flex md:align-middle">
