...
<div class="h-screen animate-show flex flex-col overflow-auto">
    <!-- NAVBAR -->
    <div class="lg:ml-auto w-full lg:w-[calc(100%-5rem)] [:not(:lg)]:variant-soft-tertiary bg-transparent [:not(:lg)]:shadow-lg [:not(:lg)]:text-primary-500 text-primary-500 dark:text-tertiary-100">
        <Toast/>
